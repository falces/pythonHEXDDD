...
class TestEventDispatcher:
    ...
    def test_publish_handles_subscriber_exceptions(self):
        ...
        failing_subscriber.handle = Mock(side_effect=RuntimeError("Subscriber error"))
    ...
    def test_publish_multiple(self):
        ...
        subscriber.subscribed_to = Mock(return_value=[HelloWorldCreated, HelloWorldDeleted])
