...
class HelloWorldCreated(DomainEvent):
    """
    Evento de dominio: Se ha creado un nuevo HelloWorld.
    
    Este evento se dispara cuando se crea exitosamente un HelloWorld
    ...
    def __repr__(self) -> str:
        return f"HelloWorldCreated(id={self.hello_world_id}, greeting={self.greeting})"
